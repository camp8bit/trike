...
#define NES_LEFT SNES_LEFT
#define NES_RIGHT SNES_RIGHT
#define NES_DOWN SNES_DOWN
#define NES_UP SNES_UP
#define NES_A SNES_A
#define NES_B SNES_B
#define NES_START SNES_START
#define NES_SELECT SNES_SELECT
...
TestPanel* panels[NUM_PANELS] = { 
    new TestPanel(0, SIDE_PANEL, NES_LEFT),
    new TestPanel(SIDE_PANEL, SIDE_PANEL + BACK_PANEL, NES_DOWN),
    new TestPanel(SIDE_PANEL + BACK_PANEL, SIDE_PANEL + BACK_PANEL + SIDE_PANEL, NES_RIGHT),
    new TestPanel(SIDE_PANEL + BACK_PANEL + SIDE_PANEL, SIDE_PANEL + BACK_PANEL + SIDE_PANEL + FRONT_PANEL, NES_UP)
};
...
void loop() { 
  ...
  if (millis() - codeEnabledAt < 5000){
    ...
    panels[1]->drawSolid(CRGB(128,0,0));
    panels[3]->drawSolid(CRGB(64,64,64));
  } else {
    byte m = mode;
